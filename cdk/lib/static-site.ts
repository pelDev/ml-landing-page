...
export class StaticSite extends Construct {
  constructor(
    ...
    let siteDomain = props.domainName;

    if (props.siteSubDomain) {
      siteDomain = props.siteSubDomain + "." + props.domainName;
    }

    const siteBucket = new s3.Bucket(this, `SiteBucket-Website`, {
    ...
    // TLS CERTIFICATE
    const certificate = new acm.Certificate(this, `ml-cert-website`, {
    ...
    const cloudfrontOAI = new cloudfront.OriginAccessIdentity(
      this,
      `cloudfront-static-site-OAI-website`,
      {
    ...
    const cloudfrontDistribution = new cloudfront.CloudFrontWebDistribution(
      this,
      `CloudFrontDistribution-website`,
      {
